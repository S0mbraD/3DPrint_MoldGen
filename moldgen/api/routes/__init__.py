...
from moldgen.api.routes import advanced, ai_agent, ai_chat, ai_generate, analysis, export, inserts, models, molds, simulation, system
...
api_router.include_router(ai_generate.router, prefix="/ai/generate", tags=["ai-generate"])
